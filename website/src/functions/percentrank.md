...
description: "Percent Rank: the percentage of the values in the preceding window that are strictly below the current value."
---
...
| --- | --- | --- | --- | --- |
| `optInTimePeriod` | integer | 100 | 2–100000 | Number of preceding bars ranked against |
...
[MIN](/functions/min.md) · [MAX](/functions/max.md) · [STDDEV](/functions/stddev.md)
