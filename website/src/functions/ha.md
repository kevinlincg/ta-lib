...
description: "Heikin-Ashi candles: a per-bar OHLC-to-OHLC transform that redraws the chart from averaged prices instead of raw ones."
---
...
[AVGPRICE](/functions/avgprice.md) · [MEDPRICE](/functions/medprice.md) · [TYPPRICE](/functions/typprice.md) · [WCLPRICE](/functions/wclprice.md) · [EMA](/functions/ema.md)
