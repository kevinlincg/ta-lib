...
| `build_baseline_serve.py` | Builds `bin/ta_baseline_serve` (the frozen released-baseline oracle for `ta_regtest --fuzz-baseline`; which release is `serve_version.RELEASE_TAG`) — called by `build.py` |
