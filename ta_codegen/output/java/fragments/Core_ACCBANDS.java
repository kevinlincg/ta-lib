...
/**** Streaming API *****/
   ...
   public static final class AccbandsStream {
       ...
       * by one and nothing else moves — {@link #value(AccbandsOut)} keeps answering the previous
       ...
       * {@link #value(AccbandsOut)} still answers the previous value. Re-feed the bar when a
