...
/**** Streaming API *****/
   ...
   public static final class VortexStream {
       ...
       * by one and nothing else moves — {@link #value(VortexOut)} keeps answering the previous
       ...
       * {@link #value(VortexOut)} still answers the previous value. Re-feed the bar when a
