...
/**** Streaming API *****/
   ...
   public static final class HaStream {
      ...
      public void update( double inOpen, double inHigh, double inLow, double inClose, HaOut out ) {
         ...
         update( inOpen, inHigh, inLow, inClose );
      ...
      /* Commit with no sink to write: a caller inside this package reads the
         outputs off cur_outHAOpen / cur_outHAHigh / cur_outHALow / cur_outHAClose instead. */
      void update( double inOpen, double inHigh, double inLow, double inClose ) {
