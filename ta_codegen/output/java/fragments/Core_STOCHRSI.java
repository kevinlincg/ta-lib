...
/**** Streaming API *****/
   ...
   public static final class StochrsiStream {
       ...
       * by one and nothing else moves — {@link #value(StochrsiOut)} keeps answering the previous
       ...
       * {@link #value(StochrsiOut)} still answers the previous value. Re-feed the bar when a
