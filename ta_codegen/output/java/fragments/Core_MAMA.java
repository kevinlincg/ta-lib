...
/**** Streaming API *****/
   ...
   public static final class MamaStream {
       ...
       * by one and nothing else moves — {@link #value(MamaOut)} keeps answering the previous
       ...
       * {@link #value(MamaOut)} still answers the previous value. Re-feed the bar when a
