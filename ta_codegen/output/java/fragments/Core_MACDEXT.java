...
/**** Streaming API *****/
   ...
   public static final class MacdextStream {
       ...
       * by one and nothing else moves — {@link #value(MacdextOut)} keeps answering the previous
       ...
       * {@link #value(MacdextOut)} still answers the previous value. Re-feed the bar when a
