...
/**** Streaming API *****/
   ...
   public static final class HtPhasorStream {
       ...
       * by one and nothing else moves — {@link #value(HtPhasorOut)} keeps answering the previous
       ...
       * {@link #value(HtPhasorOut)} still answers the previous value. Re-feed the bar when a
