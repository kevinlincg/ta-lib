...
/**** Streaming API *****/
   ...
   public static final class HtSineStream {
       ...
       * by one and nothing else moves — {@link #value(HtSineOut)} keeps answering the previous
       ...
       * {@link #value(HtSineOut)} still answers the previous value. Re-feed the bar when a
