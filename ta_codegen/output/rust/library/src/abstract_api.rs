...
pub enum FuncId {
    ...
    FOSC,
    /// Williams Fractal (swing pivot detector) — [`Core::FRACTAL`](crate::Core::FRACTAL).
    FRACTAL,
...
static FUNC_TABLE: [FuncInfo; 197] = [
    FuncInfo {
        id: FuncId::AC,
        name: "AC",
    ...
    FuncInfo {
        ...
        flags: FuncFlags(0x02000000),
        inputs: &[InputInfo { param_name: "inPriceHL", kind: InputType::Price, flags: InputFlags(0x00000006) }, ],
        opt_inputs: &[OptInputInfo { param_name: "optInLeftBars", display_name: "Left Bars", hint: "Bars required to the left of the pivot", flags: OptInputFlags(0x00000000), kind: OptInputType::IntegerRange { min: 1, max: 100000, default: 2, suggested: (1, 10, 1) } }, OptInputInfo { param_name: "optInRightBars", display_name: "Right Bars", hint: "Bars required to the right of the pivot", flags: OptInputFlags(0x00000000), kind: OptInputType::IntegerRange { min: 1, max: 100000, default: 2, suggested: (1, 10, 1) } }, ],
